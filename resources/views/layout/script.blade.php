    ...
    <script src="{{ asset('vendor/startbootstrap-sb-admin-2-gh-pages/vendor/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('vendor/startbootstrap-sb-admin-2-gh-pages/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <!-- Core plugin JavaScript-->
    <script src="{{ asset('vendor/startbootstrap-sb-admin-2-gh-pages/vendor/jquery-easing/jquery.easing.min.js') }}"></script>
    ...
    <script src="{{ asset('vendor/startbootstrap-sb-admin-2-gh-pages/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('vendor/startbootstrap-sb-admin-2-gh-pages/js/demo/chart-pie-demo.js') }}"></script>

        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
        <script src="{{ asset('vendor/startbootstrap-sb-admin-2-gh-pages/js/scripts.js') }}"></script>
        <script src="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/umd/simple-datatables.min.js" crossorigin="anonymous"></script>
        <script src="{{ asset('vendor/startbootstrap-sb-admin-2-gh-pages/js/datatables-simple-demo.js') }}"></script>
    ...
    <!-- Custom scripts for all pages-->
    <script src="{{ asset('vendor/startbootstrap-sb-admin-2-gh-pages/vendor/js/sb-admin-2.min.js') }}"></script>
