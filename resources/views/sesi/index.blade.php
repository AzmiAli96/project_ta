...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Tables Data Sesi</h1>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">DataTables Sesi</h6>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-3">
            <!-- Topbar Search -->
            <form action="/sesi" method="GET" class="d-none d-sm-inline-block form-inline mr-auto md-3 my-2 my-md-0 mw-100 navbar-search">
                @csrf
        ...
        <div class="table-responsive">
            <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $sesis->firstItem()+$loop->index }}</td>
                        <td>{{ $sesi->sesi }}</td>
                        <td>{{ $sesi->waktu }}</td>
                        <td>
