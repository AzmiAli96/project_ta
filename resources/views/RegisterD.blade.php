...
<head>
    ...
    <link href="vendor/startbootstrap-sb-admin-gh-pages/css/styles.css" rel="stylesheet" />
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Create Account Dosen</h3>
                                </div>
                                <div class="card-body">
                                    <form>
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputNip" type="nip" placeholder="2233115566" />
                                        ...
                                        <div class="mb-3">
                                            <select class="form-select form-control-lg" name="kelas">
                                                <option selected>roll anda</option>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create an Account Dosen!</h1>
                            </div>
                            <form class="user">
                            <div class="form-group">
                                    <input type="number" class="form-control form-control-user" id="exampleInputNim" placeholder="NIP">
                                </div>
                                ...
                                <div class="form-group">
                                            <select class="form-select form-control" name="peran">
                                                <option selected hidden>pilihlah Roll anda</option>
                                                <option value="1">Pembimbing</option>
                                                <option value="2">Penguji</option>
                                            </select>
                                        </div>
